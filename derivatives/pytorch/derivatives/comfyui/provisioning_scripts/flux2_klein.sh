...
LORA_MODELS=(
    "https://huggingface.co/fal/flux-2-klein-4B-outpaint-lora/resolve/main/LyNiaZ53Tudg0J6sT8Xbx_pytorch_lora_weights_comfy_converted.safetensors,flux-2-klein-4B-outpaint-lora.safetensors"
)
